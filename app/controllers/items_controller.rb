class ItemsController < ApplicationController
  before_action :set_item, only: %i[ show edit update destroy toggle_checked]
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to items_path, status: :see_other, notice: "Item foi apagado com sucesso." }
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:description, :list_id, :checked)
    end
end
